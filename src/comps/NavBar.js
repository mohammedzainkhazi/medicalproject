                ...
                <div className="container mx-auto flex flex-wrap justify-evenly p-5 flex-col md:flex-row items-center m-0">
                    ...
                    </a>
                    {
                        ...
                        <nav className="md:ml-auto cursor-pointer flex flex-wrap items-center text-base justify-center">
                            ...
                            <a href="#GRAPH" className="mr-5 hover:text-gray-900">Graph</a>
                        </nav> 
                        <button className="inline-flex items-center bg-orange-400 border-0 rounded-[20px] py-2 px-3 focus:outline-none hover:bg-orange-200 text-white mt-4 md:mt-0" onClick={signout}>LOGOUT
                        </button>
                        </> : <div />
                    }
                </div>
